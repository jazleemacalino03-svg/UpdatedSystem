...
mongoose
  .connect(
    "mongodb+srv://john:jeysi@cluster0.8juhfzt.mongodb.net/farmops?retryWrites=true&w=majority"
  )
...
const verificationCodes = {}; // temporary store

const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "jazleemacalino03@gmail.com",
    pass: "vnzezrybyoloyhtg"
  }
});
...
app.get("/api/reports", async (req, res) => {
  try {
    ...
    res.json({
      ...
      dailyHistory: report.dailyHistory
    });
